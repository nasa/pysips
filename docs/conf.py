...
author = 'Geoffrey Bomarito, Patrick Leser'
...
# Intersphinx mapping (with timeout to avoid network issues in CI)
intersphinx_mapping = {
    'python': ('https://docs.python.org/3', None),
    'numpy': ('https://numpy.org/doc/stable/', None),
    'sklearn': ('https://scikit-learn.org/stable/', None),
}
intersphinx_timeout = 10  # Timeout for intersphinx
